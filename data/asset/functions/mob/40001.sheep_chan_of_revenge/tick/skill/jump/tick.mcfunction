...
# アニメーション
    execute if score @s General.Mob.Tick matches 0 run function asset:mob/40001.sheep_chan_of_revenge/tick/util/jump
...
# 演出
    ...
    execute if score @s General.Mob.Tick matches 10 run function asset:mob/40001.sheep_chan_of_revenge/tick/util/step
