#> asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/tick
#
# 巨大羊毛攻撃・融解タイプ
#
...
# 1回目
    ...
    # 予告表示
        execute if score @s General.Mob.Tick matches 35 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/prediction.m {Bounds:25}
    # 戻る
        execute if score @s General.Mob.Tick matches 60 positioned ~ ~150 ~ facing entity @p[gamemode=!spectator] feet rotated ~ 0 positioned as @s run tp @s ~ ~ ~ ~ ~
        execute if score @s General.Mob.Tick matches 60 at @s run tp @s ~ ~150 ~
    ...
    # 攻撃
        execute if score @s General.Mob.Tick matches 73 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/attack

# 2回目
    # 溶ける
        execute if score @s General.Mob.Tick matches 85 run function asset:mob/40001.sheep_chan_of_revenge/tick/util/melt
    # 予告表示
        execute if score @s General.Mob.Tick matches 95 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/prediction.m {Bounds:25}
    # 戻る
        execute if score @s General.Mob.Tick matches 120 positioned ~ ~150 ~ facing entity @p[gamemode=!spectator] feet rotated ~ 0 positioned as @s run tp @s ~ ~ ~ ~ ~
        execute if score @s General.Mob.Tick matches 120 at @s run tp @s ~ ~150 ~
    ...
    # 攻撃
        execute if score @s General.Mob.Tick matches 133 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/attack

# 3回目
    # 溶ける
        execute if score @s General.Mob.Tick matches 145 run function asset:mob/40001.sheep_chan_of_revenge/tick/util/melt
    # 予告表示
        execute if score @s General.Mob.Tick matches 155 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/prediction.m {Bounds:5}
    # 戻る
        execute if score @s General.Mob.Tick matches 180 positioned ~ ~150 ~ facing entity @p[gamemode=!spectator] feet rotated ~ 0 positioned as @s run tp @s ~ ~ ~ ~ ~
        execute if score @s General.Mob.Tick matches 180 at @s run tp @s ~ ~150 ~
    ...
    # 最終攻撃
        execute if score @s General.Mob.Tick matches 193 run function asset:mob/40001.sheep_chan_of_revenge/tick/skill/giant_wool/melt/last_attack
