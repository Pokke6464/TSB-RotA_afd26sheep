...
# 残機更新
    bossbar set asset:co_gem_former name [{"translate":"絡繰仕掛の%1$s像","color":"white","with":[{"text":"改","color":"aqua"}]},{"translate":"【%s×%s】","with":[{"text":"\uE300","font":"icon"},{"score":{"name":"@s","objective":"1JK.RemainingPlayerLife"}}]}]
# HP最大値調整
