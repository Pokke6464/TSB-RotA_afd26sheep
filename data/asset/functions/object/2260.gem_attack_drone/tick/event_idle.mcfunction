...
# プレイヤーターゲット処理
    execute if entity @s[tag=2260.IsTarget] if score @s General.Object.Tick matches 1 run function asset:object/2260.gem_attack_drone/tick/summon_target_line {Color:16733525}
...
# 予告
    execute if entity @s[tag=!2260.IsAdditionalAttack] if score @s General.Object.Tick = @s 2260.PredictionTime at @s run function asset:object/2260.gem_attack_drone/tick/prediction.m {Length:80, Tick:50}
    execute if entity @s[tag=2260.IsAdditionalAttack] if score @s General.Object.Tick = @s 2260.PredictionTime at @s run function asset:object/2260.gem_attack_drone/tick/prediction.m {Length:40, Tick:50}
